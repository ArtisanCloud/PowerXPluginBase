          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <div class="space-y-2 text-sm">
                ...
                <div class="space-x-2">
                  <UBadge v-for="(value, label) in store.selected.incident.labels" v-if="value" :key="label" variant="soft">#{{ label }}</UBadge>
                </div>
              </div>
            </div>
...
import IncidentTimeline from '~/app/components/operations/IncidentTimeline.vue'
