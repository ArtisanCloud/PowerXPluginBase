...
export PX_DB_DSN="postgres://user:pass@localhost:5432/powerx_plugin_scrum?sslmode=disable"
```
...
database:
  dsn: "postgres://user:pass@localhost:5432/powerx_plugin_scrum?sslmode=disable"
  schema: "scrum"
```
